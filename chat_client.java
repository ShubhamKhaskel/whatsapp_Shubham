...
public class chat_client implements ActionListener
{
    JTextField text;
    JPanel a1;
    ...
    chat_client()
    {
         ...
         f.setLocation(800,50); //to set the location of gui window in monitor 200 from left and 50 from top
...
*/
    ...
    {
        new chat_client();       //main method call korlei jate gui ashe
        try {
